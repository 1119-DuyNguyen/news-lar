              ...
              <div class="card-body">
                <form method="POST" action="{{ route('password.store') }}" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" type="email" class="form-control" name="email" tabindex="1" required autofocus value="{{ $request->route('email') }}">
                    <input id="email" type="hidden" class="form-control" name="token" tabindex="1" required autofocus value="{{ $request->route('token') }}">
                    @error('email')
                        <code>{{ $message }}</code>
                    @enderror
