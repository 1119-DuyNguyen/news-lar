                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('password.store') }}" class="needs-validation" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  type="hidden" class="form-control" name="token" tabindex="1" required autofocus value="{{ $request->route('token') }}">
                                    <input id="email" type="email" class="form-control" name="email" tabindex="1" required autofocus value="{{ $request->get('email') }}">
                                    @error('email')
                                    <code>{{ $message }}</code>
                                    @enderror
